...
<table width="293" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="62" align="right" valign="middle" class="font">留言人:</td>
                ...
                <tr>
                  <td align="right" valign="middle" class="font">电　话:</td>
                ...
                <tr>
                  <td align="right" valign="top" class="font">内　容:</td>
...
<input type="reset" name="Submit2" value="重置" class="textbotton"></td>
                </tr>
              </table>
            </td>
          </form>
