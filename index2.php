				...
				<form action="checklogin.php" method=post name="form1" onSubmit="return checklogin()">
					 ...
					 <div>
					    ...
					    <span><input name="authcode" type="text"  style="border-radius:10px;margin-top: 5px;"></span>
					     <li><span><image id="captcha_img" border="1" src="captcha.php?r=<php? echo rand();?>"width="100"/></span><a href="javascript:void(0)"onclick="document.getElementById('captcha_img').src='captcha.php?r='+Math.random()" style="margin-left: 20px">换一个？</a></li><br\>
					 </div>
					<div class="sign" style="margin-top: 10px;">
						<input type="submit" name="Submit" value="登陆" class="btn btn-success">
