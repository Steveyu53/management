...
<!--
	function checkdata()
	{
		...
		if(!CheckIsNull(form2.email,"请输入e-mail！")) return false;
  ...
  <tr align="left" valign="top">
    ...
    <td>
      <table  class="table" width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <form name="form2" method="post" action="admin/save_hire.php" onsubmit="return checkdata()">
          <tr>
            <td align="center" valign="top" class="downkuan" >
              ...
              <table width="99%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC" class="xu_kuan">
                <tr align="left" valign="middle" bgcolor="#FFFFFF">
                  <td height="30" colspan="2" class="font"> <div align="center"><font color="#003D79"><strong>房屋求租信息登记</strong></font></div></td>
                </tr>
                <tr align="left" valign="middle" bgcolor="#FFFFFF">
