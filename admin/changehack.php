...
$sql="select * from house_hack where id=$id";
 $res=mysql_query($sql);
  ...
  <td width="1" bgcolor="#CCCCCC"></td>
    <td>
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="tables" >
        <form enctype="multipart/form-data" name="form2" method="post" action="save_change_hack.php" onsubmit="return checkdata()">
          <tr>
            <td align="center" valign="top" class="downkuan" >
              ...
              <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" class="xu_kuan" height="30">
                <tr align="left" valign="middle" bgcolor="#FFFFFF">
                  <td height="30" colspan="2" class="font"> <div align="center"><strong><font color="#003D79">房屋出租信息修改</font></strong></div></td>
                </tr>
                <tr align="left" valign="middle" bgcolor="#FFFFFF">
                  <td height="30" colspan="2" class="font"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="495" ><input type="text" name="head" value="<?php echo $rs["head"]?>" ></td>
                      </tr>
                    </table></td>
                </tr>
                <tr align="left" valign="middle" >
                  <td width="277" class="font">&nbsp;小区名称：
                    <input name="house_name" type="text" class="textinput" size="20" maxlength="50" value="<?php echo $rs["house_name"]?>" >
                    </td>
  ...
  ?>
    ...
    ?>
        ...
        <option value=<?php echo $i?>><?php echo $i?></option>
          ...
          ?> </select>楼<font color="#FF6600">**</font> </td>
                </tr>
                <tr align="left" valign="middle" bgcolor="#FFFFFF">
                  <td height="101" colspan="2" class="font"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="495"> <textarea name="pb" cols="70" rows="6" class="textinput"><?php echo $rs["jg_time"]?></textarea></td>
                      </tr>
                    </table></td>
                </tr>
                <tr align="left" valign="middle">
                  <td height="30" class="font">&nbsp;联 系 人：
                    <input value="<?php echo $rs["man"]?>" name="man" type="text" class="textinput" size="20" maxlength="50" ></td>
