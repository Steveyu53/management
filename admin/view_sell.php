...
<center>
    ...
    <br>
    <br>
    <a href="view_sell.php?pass=否" class="linkfont">浏览<font color="#FF0000">未通过</font>的记录</a>　　<a href="view_sell.php?pass=是" class="linkfont">浏览<font color="#FF0000">已通过</font>的记录</a>
    <br>
  </center>
  <br>
...
?>
   ...
   ?>
    <tr>
      ...
      <td><a href="del_sell.php?id=<?php echo $rs["id"]?>" class="linkfont">删除</a></td>
      <td><a href="changesell.php?id=<?php echo $rs["id"]?>" class="linkfont" >查看或修改</a></td>
    </tr>
 <?php
   }
	   ?>
