        ...
        <tr align="left" valign="top">
            <table border="0" cellpadding="0" cellspacing="0">
              <form action="hire.php" method=post name="search" onSubmit="return checksearch()">
                ...
                <td width="100"></td>
                  <td width="163" height="25" class="font" style="text-align: center;"><font color="#003D79"><strong>区域：</strong></font>
...
echo " <option value=$rs0[area_name]>$rs0[area_name]</option>";
	?>
        ...
        name=search_hx style="FONT-SIZE: 9pt; WIDTH: 90px; FONT-FAMILY: 宋体; HEIGHT: 22px" >
                  ...
                  <td height="25" class="font"><font color="#003D79" style="margin-left: 30px;"><strong>是否中介：</strong></font>
