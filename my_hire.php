...
if($_GET['do'] == "delete"){
    $id = $_GET['id'];
    $result = mysql_query("delete from house_hire where id in ($id);");
    if($result){
                ...
                <div>
                    <form name="form1" method="post" action="">
                        <table class="table" cellspacing="0" cellpadding="0" style="border:solid 1px ;background-color: white;">
                            ...
                            <?php
                                $strSql="select  * from house_hire where  man='$username' order by id desc";
                            ...
                            <tr>
                                ...
                                <td><input class="btn btn-success"  value="修改" type="button" onClick="location.href='changemyhire.php?id=<?php echo $rs['id']; ?>'"></td>
