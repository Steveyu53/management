...
?>
          <tr>
            <td align="center" valign="top" class="downkuan" >
              <span class="font"><p>房源编号：<font color=red><?php echo $rs["bh"]?></font>(如果您对此该信息有意向，请记住此编号)　　　　　　　　　　点击次数：<font color=red><?php echo $rs["click"]?></font></p></span><br>
              <br>
              <table width="99%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC" class="xu_kuan">
                <tr align="left" valign="middle" bgcolor="#FFFFFF">
                  <td height="30" colspan="2" class="font"> <div align="center"><font color="#003D79"><strong>房屋求购信息详情</strong></font></div></td>
                </tr>
                <tr align="left" valign="middle" bgcolor="#FFFFFF">
                ...
                <tr align="left" valign="middle" class="odd">
                  <td width="305" height="30" class="font">&nbsp;要求面积：
                    <?php echo $rs["min_area"]?>
                    ㎡ ~
                    <?php echo $rs["max_area"]?>
                    ㎡　 </td>
